...
<title>Power Pace Courier Services</title>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="900" style="padding-top:20px;">
  <tbody><tr>
    <td width="900">
    <div id="amazingslider-wrapper" style="display:block;position:relative;max-width:900px;margin:0px auto 56px;">
        <div id="amazingslider-1">
            <ul class="amazingslider-slides" style="display:none;">
                <li><img src="images/2.3-Courier.jpg" />
                </li>
                <li><img src="images/images.jpg" />
                </li>
                <li><img src="images/nprcargo-slider1.jpg" />
                </li>
            </ul>
  ...
  <tbody><tr>
    <td bgcolor="#FFFFFF" width="900"><table border="0" align="center" width="99%">
      <tbody><tr>
        ...
        <p class="navi" align="justify"><strong>Courier Tracking System  </strong> is the simplest solution for <strong>Courier &amp; Cargo Tracking</strong> Business. If you need to enable Tracking Option in your existing or new website, this is quickest Software Solution. </p>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="900">
  ...
  <tr>
    <td bgcolor="#2284d5" height="40">&nbsp;</td>
    <td bgcolor="#2284d5" width="800"><p class="lowerstyle">
    
    </p>
      <p class="lowerstyle">Designed and Developed by Komal Agarwal and ....</p></td>
  </tr>
</tbody></table>
